# Dropwizard Template Config [![CircleCI](https://circleci.com/gh/serhiypal/dropwizard-template-config/tree/master.svg?style=svg)](https://circleci.com/gh/serhiypal/dropwizard-template-config/tree/master)
